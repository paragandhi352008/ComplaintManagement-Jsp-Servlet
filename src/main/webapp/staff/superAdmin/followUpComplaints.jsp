		...
		<div class="row">
			<div class="col-md-6 offset-md-3">
				<div class="card paint-card">
					<div class="card-body">
						<p class="fs-4 text-center">Follow-up Complaints</p>
						...
						<form action="followUpComplaints.jsp" name="select_problem"
					...
					<div class="card-body">
						...
						<table class="table table-hover" id="table">
							...
							<tbody>
								...
								List<Complaint> complaint = cdao.getAllFollowUpComplaints(fromDate, toDate);
