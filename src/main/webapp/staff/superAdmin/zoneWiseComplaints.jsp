		...
		<div class="row">
			<div class="col-md-12">
				<div class="card paint-card">
					<div class="card-body">
						<p class="fs-4 text-center">Zone wise complaints report</p>
						<br>
						...
						<form action="zoneWiseComplaints.jsp" name="select_problem" method="post"
							...
							<div class="row">
								...
								<div class="col-md-4">
									...
									<label class="form-label" for="staff_role">Select Zone</label>

									<select id="inputState" name="zone_id" class="form-select">
										<option selected disabled value="">--select--</option>
										<%
										ZoneDao zdao = new ZoneDao(DbConnect.getCon());
										List<Zone> zone = zdao.getAllZones();
										for (Zone z : zone) {
										%>
						...
						<div class="card-body">
							...
							<table class="table table-hover" id="table">
								...
								<tbody>
									...
									List<Complaint> complaint = cdao.getZoneWiseComplaints(fromDate, toDate, zoneId);
