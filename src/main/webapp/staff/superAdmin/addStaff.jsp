			...
			<div class="card paint-card">
				<div class="card-body">
					<p class="fs-4 text-center">
						<span class="fa fa-3x fa-user-circle"></span> <br>Add Staff
					</p>
					...
					<form action="../../addStaff" name="add_staff"
						...
						<div class="mb-3">
							...
							<textarea name="staff_address" class="form-control"
						...
						<div class="mb-3">
							<label class="form-label">Email address</label> <input
								name="staff_email" type="email" class="form-control"
						...
						<div class="form-group">
							<label for="staff_role">Role</label> <select id="inputState"
								...
								List<Role> list1 = dao1.getAllRolesWithoutSuperAdmin();
								for (Role r : list1) {
								%>
