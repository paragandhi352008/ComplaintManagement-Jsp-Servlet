...
%>
<%@ include file="engineer/navbar.jsp"%>
<%
} else if (roleId == 3) {
%>
					...
					<form action="../resetPasswordByStaff" name="reset_password"
						...
						<div class="mb-3">
							<label class="form-label">Re-enter new Password</label> <input
								name="reenter_new_password" type="password" class="form-control"
								id="password" required placeholder="Re-enter new password">
						</div>
						<br>
