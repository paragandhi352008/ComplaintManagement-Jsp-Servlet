		...
		<div class="row">
			<div class="col-md-12">
				<div class="card paint-card">
					<div class="card-body">
						<p class="fs-4 text-center">All Complaints' Status</p>
						<br>
						...
						<form action="allComplaintsStatus.jsp" name="select_problem"
							...
							<div class="row">
								...
								<div class="col-md-4">
									...
									<label class="form-label" for="staff_role">Select
										Status</label> <select id="inputState" name="status_id"
										class="form-select">
										<option selected disabled value="">--select--</option>
										<%
										StatusDao sdao = new StatusDao(DbConnect.getCon());
										List<Status> lstatus = sdao.getAllStatus();
										for (Status s : lstatus) {
										%>
										<option value="<%=s.getStatusId()%>"><%=s.getName()%></option>
										<%
										}
										%>
									</select>
					...
					<div class="card-body">
						...
						<table class="table table-hover" id="table">
							...
							<tbody>
								...
								List<Complaint> complaint = cdao.getAllComplaintsByStatusId(fromDate, toDate, statusId);
