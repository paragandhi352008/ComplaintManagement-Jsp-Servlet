		...
		<div class="row">
			<div class="col-md-6 offset-md-3">
				<div class="card paint-card">
					<div class="card-body">
						<p class="fs-4 text-center">Operator Registered Complaints</p>
						<br>
						...
						<form action="operatorRegisteredComplaints.jsp" name="select_problem"
					...
					<div class="card-body">
						...
						<table class="table table-hover" id="table">
							...
							<tbody>
								...
								List<Complaint> complaint = cdao.getAllComplaintsCreatedByOperator(fromDate, toDate);
