			...
			<div class="card paint-card">
				<div class="card-body">
					<p class="fs-4 text-center">
						<span class="fa fa-3x fa-user-circle"></span> <br>Edit Staff
					</p>
					...
					<form action="../../editStaff" name="add_staff" method="post"
						...
						<div class="mb-3">
							<label class="form-label">Email address</label> <input
								...
								required aria-describedby="emailHelp" value="<%=s.getEmail()%>">
						</div>
						...
						<input type="hidden" name="staff_id" value="<%=s.getUserId()%>">
						</div>
