...
<body>
	...
	<div class="container p-5">
		<p class="text-center fs-4">In-Progress complaints to work on</p>
				...
				<div class="card-body">
					...
					<table class="table table-hover" id="table">
						...
						<tbody>
							...
							List<Complaint> list = dao.getAllInProgressComplaintsAssignedToEngineer(staff.getUserId());
							...
							<tr>
								...
								<td><a href="editStatus.jsp?complaintId=<%= c.getComplaintId() %>"
