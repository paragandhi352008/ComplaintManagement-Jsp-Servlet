...
<body>
	...
	<div class="container p-3">
		<p class="text-center fs-3">Register Complaint</p>
				...
				<div class="card-body">
					...
					<table class="table table-hover" id="table">
						...
						<tbody>
							...
							List<Citizen> list = dao.getAllCitizens();
							for (Citizen c : list) {
							%>
							<tr>
								...
								<td><%=c.getLastName()%></td>
								<td><%=c.getMobile()%></td>
								<td><a href="registerComplaint.jsp?citizenId=<%=c.getId()%>"
									class="btn btn-success btn-sm">Add Complaint</a> <%-- <a
									href="../../deleteStaff?userId=<%=c.getId()%>"
