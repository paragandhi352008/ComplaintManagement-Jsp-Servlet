	...
	<div class="row">
		<div class="col-md-12">
			<div class="card paint-card">
				<div class="card-body">
					<p class="fs-4 text-center">View Complaint</p>
					<br>
						...
						<div class="row">
							...
							<div class="col-md-6 mt-3">
								...
								<input type="radio" id="gender" name="staff_gender" value="Male"
									...
									name="staff_gender" disabled value="Female" required>Female
								<%
								} else if (citizen.getGender().equalsIgnoreCase("Female")) {
								%>
								<input type="radio" id="gender" name="staff_gender" value="Male"
									required>Male <input type="radio" id="gender"
									name="staff_gender" disabled value="Female" required checked>Female
								<%
								}
								%>
							</div>
							...
							<div class="col-md-6 mt-3">
								...
								<textarea name="staff_address" class="form-control" id="address"
									rows="3" disabled required><%=citizen.getAddress()%></textarea>
							</div>
							...
							<div class="col-md-6 mt-3">
								<label class="form-label" for="problem_type">Status </label> <select
									name="status_id" disabled name=problem_type class="form-select">
									<%
									StatusDao stdao = new StatusDao(DbConnect.getCon());
									Status status = stdao.getStatusById(complaint.getStatusId());
									%>
