...
<body>
	...
	<div class="container p-5">
		...
		<c:if test="${empty citizenObj}">
			<c:redirect url="../citizenLogin.jsp"></c:redirect>
		</c:if>
				...
				<div class="card paint-card">
					<div class="card-body text-center text-success">
						...
						<p class="fs-3 text-center">
							Pending Complaints<br><%=dao.countPendingComplaintsByCitizenId(citizen.getId())%>
						</p>
					</div>
				</div>
			</div>
			...
			<div class="col-md-5">
				<div class="card paint-card">
					<div class="card-body text-center text-success">
						<i class="fas fa-user-md fa-3x"></i><br>
						<p class="fs-3 text-center">
							Total Registered Complaints<br><%=dao.countTotalComplaintsByCitizenId(citizen.getId())%>
						</p>
					</div>
				</div>
			</div>
