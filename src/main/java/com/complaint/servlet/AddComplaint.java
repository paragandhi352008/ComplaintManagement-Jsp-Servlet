...
@WebServlet("/addComplaintByCitizen")
public class AddComplaint extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			boolean f = dao.addComplaintByCitizen(statusId, citizenId, problemId, subproblemId, createdDateTime, notes,
					pre, date, complaintNo);
